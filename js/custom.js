...
function calculate() {
	...
	var radioValue2 = $("input[name='style']:checked").val();
	var radioValue3 = $("input[name='strength']:checked").val();
	document.getElementById("imgg").src = radioValue2;
	var pric = '$54.99';
if(radioValue3 == 'Standard') {	
	if(radioValue2 == 'images/silver.jpg') {
		if (radioValue == '18'){
			pric = '$54.99';
	...
	if(radioValue2 == 'images/silver.jpg') {
	  ...
	  document.getElementById("price").innerHTML = pric;
	}
function calculate2(obj) {
	  document.getElementById("imgg").src = obj.value;
	}
function coast() {	
    var form = $(".page1");
    var field = [];
...
/*	var string = document.getElementById("price").innerHTML;
	...
	string = string*document.getElementById("quantity").value;
	string = string.toFixed(2);
	string = '$' + string;
	document.getElementById("coast").innerHTML = string;*/
...
$(document).ready(function(){
	$("input[type='radio']").click(function(){
            ...
            if(radioValue == '$54.99'){
				if(radioValue2 == 'images/silver.jpg') {
               // alert("Size - " + radioValue + " Style - " + radioValue2);
				}
            }
        });
   ...
   $('.qplus').click(function(e){
     ...
     $('.qminus').click(function(e){
        ...
        // If is not undefined
			...
			else {$('.qminus').attr('disabled','disabled');}
			
			if(quantity==2){$('.qminus').attr('disabled','disabled'); }
    });
...
(function($){
  "use strict";
	...
	jQuery(window).on('load', function() {
		...
		jQuery("#preloader").delay(30).fadeOut("slow");
	});
